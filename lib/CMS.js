...
const { optionalRequire } = require.main.require('./kldit/lib/util');
...
module.exports = class CMS extends mvc.BaseController
{
    static setup()
    {
        if(!CMS.inited)
        {
            ...
            require.main.require('./kldit/lib/fields/');
            require.main.require('./kldit/lib/validators/');
    ...
    static loadXmlDocument(path)
    {
        try
        {
            ...
            var json = require.main.require('./kldit/lib/document/XmlDocument')( xml );
